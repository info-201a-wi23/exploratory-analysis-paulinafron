...
For the trend of the pet species in time, due to what I got from the second plot in my visualization, I think there is no huge changes from 2015 to 2023. The ratio of dog and cat as a pet is always 7:3, which means there is 70% people who like to raise dog as a pet and 30% people who like to raise cat as a pet. So from what I learnt, people generally would like to have a dog as a pet than as a cat, ignoring some special cases such as having a pig or goat as a pet. From second plot, I noticed the most pet lisences are issued in 2021 and 2022, I think that is because covid and people need more emotional support.
